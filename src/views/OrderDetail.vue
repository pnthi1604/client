<template>
    <div class="container-top">
        ...
        <box-status-order v-for="orderStatus in orderStatuses" :key="orderStatus._id" :statusTitle="orderStatus.title" :createDate="orderStatus.createDate"></box-status-order>
